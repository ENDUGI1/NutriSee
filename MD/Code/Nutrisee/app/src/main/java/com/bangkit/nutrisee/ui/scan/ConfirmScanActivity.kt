...
class ConfirmScanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Load image from intent (support both URI and file path)
        imagePath = intent.getStringExtra("EXTRA_IMAGE_PATH")
        val imageUri = intent.getParcelableExtra<Uri>("EXTRA_IMAGE_URI")

        // Prioritize file path from copied file, fallback to original URI
        ...
        btnCencel.setOnClickListener{
            ...
            // Clear the activity stack and bring MainActivity to the front
